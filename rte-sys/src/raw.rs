...
pub const PTHREAD_MUTEX_NORMAL: Enum_Unnamed27 = Enum_Unnamed27::PTHREAD_MUTEX_TIMED_NP;
pub const PTHREAD_MUTEX_RECURSIVE: Enum_Unnamed27 = Enum_Unnamed27::PTHREAD_MUTEX_RECURSIVE_NP;
pub const PTHREAD_MUTEX_ERRORCHECK: Enum_Unnamed27 = Enum_Unnamed27::PTHREAD_MUTEX_ERRORCHECK_NP;
pub const PTHREAD_MUTEX_DEFAULT: Enum_Unnamed27 = Enum_Unnamed27::PTHREAD_MUTEX_TIMED_NP;
#[derive(Clone, Copy)]
#[repr(u32)]
...
pub const PTHREAD_MUTEX_STALLED_NP: Enum_Unnamed28 = Enum_Unnamed28::PTHREAD_MUTEX_STALLED;
pub const PTHREAD_MUTEX_ROBUST_NP: Enum_Unnamed28 = Enum_Unnamed28::PTHREAD_MUTEX_ROBUST;
#[derive(Clone, Copy)]
#[repr(u32)]
...
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_rte_lcore_state_t {
    WAIT = 0,
    RUNNING = 1,
    FINISHED = 2,
}
pub type lcore_function_t = unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void)
                                                 -> ::std::os::raw::c_int;
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_rte_rmt_call_master_t {
    SKIP_MASTER = 0,
    CALL_MASTER = 1,
}
#[repr(C)]
...
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_timer_source {
    EAL_TIMER_TSC = 0,
    EAL_TIMER_HPET = 1,
}
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_rte_lcore_role_t {
    ROLE_RTE = 0,
    ROLE_OFF = 1,
}
#[derive(Clone, Copy)]
...
pub type rte_mempool_obj_iter_t =
    ::std::option::Option<unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void,
                                                 ...
                                                 arg4: uint32_t)>;
pub type rte_mempool_obj_ctor_t = unsafe extern "C" fn(arg1: *mut Struct_rte_mempool,
                                                       arg2: *mut ::std::os::raw::c_void,
                                                       arg3: *mut ::std::os::raw::c_void,
                                                       arg4: ::std::os::raw::c_uint);
pub type rte_mempool_ctor_t = unsafe extern "C" fn(arg1: *mut Struct_rte_mempool,
                                                   arg2: *mut ::std::os::raw::c_void);
...
pub struct Struct_rte_kni_ops {
    ...
    pub change_mtu: ::std::option::Option<extern "C" fn(port_id: uint8_t,
                                                          ...
                                                          -> ::std::os::raw::c_int>,
    pub config_network_if: ::std::option::Option<extern "C" fn(port_id: uint8_t, if_up: uint8_t)
                                                                 -> ::std::os::raw::c_int>,
}
...
pub type rdline_write_char_t = unsafe extern "C" fn(rdl: *mut Struct_rdline,
                                                    arg1: ::std::os::raw::c_char)
                                                    -> ::std::os::raw::c_int;
pub type rdline_validate_t = unsafe extern "C" fn(rdl: *mut Struct_rdline,
                                                  buf: *const ::std::os::raw::c_char,
                                                  size: ::std::os::raw::c_uint);
pub type rdline_complete_t = unsafe extern "C" fn(rdl: *mut Struct_rdline,
                                                  buf: *const ::std::os::raw::c_char,
...
pub const IPPORT_WHOSERVER: Enum_Unnamed75 = Enum_Unnamed75::IPPORT_LOGINSERVER;
pub const IPPORT_ROUTESERVER: Enum_Unnamed75 = Enum_Unnamed75::IPPORT_EFSSERVER;
#[derive(Clone, Copy)]
#[repr(u32)]
...
extern "C" {
    ...
    pub fn rte_log_add_in_history(buf: *const ::std::os::raw::c_char,
                                  size: size_t)
                                  -> ::std::os::raw::c_int;
    pub fn rte_log(level: uint32_t,
                   logtype: uint32_t,
                   format: *const ::std::os::raw::c_char,
                   ...)
                   -> ::std::os::raw::c_int;
    pub fn rte_vlog(level: uint32_t,
                    logtype: uint32_t,
                    format: *const ::std::os::raw::c_char,
                    ap: va_list)
                    -> ::std::os::raw::c_int;
    ...
    pub fn rte_malloc(_type: *const ::std::os::raw::c_char,
                      size: size_t,
                      align: ::std::os::raw::c_uint)
                      -> *mut ::std::os::raw::c_void;
    pub fn rte_zmalloc(_type: *const ::std::os::raw::c_char,
                       size: size_t,
                       align: ::std::os::raw::c_uint)
                       -> *mut ::std::os::raw::c_void;
    pub fn rte_calloc(_type: *const ::std::os::raw::c_char,
                      num: size_t,
                      size: size_t,
                      align: ::std::os::raw::c_uint)
                      -> *mut ::std::os::raw::c_void;
    pub fn rte_realloc(ptr: *mut ::std::os::raw::c_void,
                       size: size_t,
                       align: ::std::os::raw::c_uint)
                       -> *mut ::std::os::raw::c_void;
    ...
    pub fn rte_malloc_get_socket_stats(socket: ::std::os::raw::c_int,
                                       socket_stats: *mut Struct_rte_malloc_socket_stats)
                                       -> ::std::os::raw::c_int;
    pub fn rte_malloc_dump_stats(f: *mut FILE, _type: *const ::std::os::raw::c_char);
    pub fn rte_malloc_set_limit(_type: *const ::std::os::raw::c_char,
                                max: size_t)
                                -> ::std::os::raw::c_int;
    pub fn rte_malloc_virt2phy(addr: *const ::std::os::raw::c_void) -> phys_addr_t;
    ...
    pub fn sched_setparam(__pid: __pid_t,
                          __param: *const Struct_sched_param)
                          -> ::std::os::raw::c_int;
    pub fn sched_getparam(__pid: __pid_t,
                          __param: *mut Struct_sched_param)
                          -> ::std::os::raw::c_int;
    pub fn sched_setscheduler(__pid: __pid_t,
    ...
    pub fn sched_rr_get_interval(__pid: __pid_t,
                                 __t: *mut Struct_timespec)
                                 -> ::std::os::raw::c_int;
    ...
    pub fn pthread_mutexattr_setprotocol(__attr: *mut pthread_mutexattr_t,
                                         ...
                                         -> ::std::os::raw::c_int;
    pub fn pthread_mutexattr_getprioceiling(__attr: *const pthread_mutexattr_t,
                                            __prioceiling: *mut ::std::os::raw::c_int)
                                            -> ::std::os::raw::c_int;
    ...
    pub fn pthread_barrierattr_getpshared(__attr: *const pthread_barrierattr_t,
                                          __pshared: *mut ::std::os::raw::c_int)
                                          -> ::std::os::raw::c_int;
    ...
    pub fn rte_eal_mp_remote_launch(f: *mut lcore_function_t,
                                    ...
                                    -> ::std::os::raw::c_int;
    pub fn rte_eal_get_lcore_state(slave_id: ::std::os::raw::c_uint) -> Enum_rte_lcore_state_t;
    ...
    pub fn rte_eal_lcore_role(lcore_id: ::std::os::raw::c_uint) -> Enum_rte_lcore_role_t;
    ...
    pub fn rte_eal_init(argc: ::std::os::raw::c_int,
                        ...
                        -> ::std::os::raw::c_int;
    pub fn rte_eal_primary_proc_alive(config_file_path: *const ::std::os::raw::c_char)
                                      -> ::std::os::raw::c_int;
    ...
    pub fn rte_ring_lookup(name: *const ::std::os::raw::c_char) -> *mut Struct_rte_ring;
    ...
    pub fn rte_mempool_count(mp: *const Struct_rte_mempool) -> ::std::os::raw::c_uint;
    pub fn rte_mempool_audit(mp: *const Struct_rte_mempool);
    pub fn rte_mempool_list_dump(f: *mut FILE);
    pub fn rte_mempool_lookup(name: *const ::std::os::raw::c_char) -> *mut Struct_rte_mempool;
    pub fn rte_mempool_calc_obj_size(elt_size: uint32_t,
                                     flags: uint32_t,
                                     sz: *mut Struct_rte_mempool_objsz)
                                     -> uint32_t;
    pub fn rte_mempool_xmem_size(elt_num: uint32_t, elt_sz: size_t, pg_shift: uint32_t) -> size_t;
    ...
    pub fn rte_mempool_walk(func:
                                ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                           ...
                                                                           arg:
                                                                               *mut ::std::os::raw::c_void)>,
                            arg: *mut ::std::os::raw::c_void);
    pub fn rte_get_rx_ol_flag_name(mask: uint64_t) -> *const ::std::os::raw::c_char;
    pub fn rte_get_tx_ol_flag_name(mask: uint64_t) -> *const ::std::os::raw::c_char;
    pub fn rte_mbuf_sanity_check(m: *const Struct_rte_mbuf, is_header: ::std::os::raw::c_int);
    ...
    pub fn rte_timer_reset(tim: *mut Struct_rte_timer,
                           ticks: uint64_t,
                           ...
                           arg: *mut ::std::os::raw::c_void)
                           -> ::std::os::raw::c_int;
    pub fn rte_timer_reset_sync(tim: *mut Struct_rte_timer,
                                ticks: uint64_t,
                                _type: Enum_rte_timer_type,
                                tim_lcore: ::std::os::raw::c_uint,
                                fct: rte_timer_cb_t,
                                arg: *mut ::std::os::raw::c_void);
    pub fn rte_timer_stop(tim: *mut Struct_rte_timer) -> ::std::os::raw::c_int;
    pub fn rte_timer_stop_sync(tim: *mut Struct_rte_timer);
    pub fn rte_timer_pending(tim: *mut Struct_rte_timer) -> ::std::os::raw::c_int;
    ...
    pub fn rte_kni_handle_request(kni: *mut Struct_rte_kni) -> ::std::os::raw::c_int;
    ...
    pub fn rte_kni_tx_burst(kni: *mut Struct_rte_kni,
                            ...
                            num: ::std::os::raw::c_uint)
                            -> ::std::os::raw::c_uint;
    pub fn rte_kni_get(name: *const ::std::os::raw::c_char) -> *mut Struct_rte_kni;
    pub fn rte_kni_get_name(kni: *const Struct_rte_kni) -> *const ::std::os::raw::c_char;
    pub fn rte_kni_register_handlers(kni: *mut Struct_rte_kni,
                                     ops: *mut Struct_rte_kni_ops)
                                     -> ::std::os::raw::c_int;
    pub fn rte_kni_unregister_handlers(kni: *mut Struct_rte_kni) -> ::std::os::raw::c_int;
    ...
    pub fn cirbuf_add_head_safe(cbuf: *mut Struct_cirbuf,
                                c: ::std::os::raw::c_char)
                                -> ::std::os::raw::c_int;
    pub fn cirbuf_add_head(cbuf: *mut Struct_cirbuf, c: ::std::os::raw::c_char);
    pub fn cirbuf_add_tail_safe(cbuf: *mut Struct_cirbuf,
                                c: ::std::os::raw::c_char)
                                -> ::std::os::raw::c_int;
    pub fn cirbuf_add_tail(cbuf: *mut Struct_cirbuf, c: ::std::os::raw::c_char);
    pub fn cirbuf_del_head_safe(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_int;
    pub fn cirbuf_del_head(cbuf: *mut Struct_cirbuf);
    pub fn cirbuf_del_tail_safe(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_int;
    pub fn cirbuf_del_tail(cbuf: *mut Struct_cirbuf);
    pub fn cirbuf_get_head(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_char;
    pub fn cirbuf_get_tail(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_char;
    ...
    pub fn cirbuf_get_buf_tail(cbuf: *mut Struct_cirbuf,
                               ...
                               size: ::std::os::raw::c_uint)
                               -> ::std::os::raw::c_int;
    pub fn cirbuf_align_left(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_int;
    pub fn cirbuf_align_right(cbuf: *mut Struct_cirbuf) -> ::std::os::raw::c_int;
    ...
    pub fn rdline_init(rdl: *mut Struct_rdline,
                       ...
                       -> ::std::os::raw::c_int;
    pub fn rdline_newline(rdl: *mut Struct_rdline, prompt: *const ::std::os::raw::c_char);
    ...
    pub fn rdline_char_in(rdl: *mut Struct_rdline,
                          c: ::std::os::raw::c_char)
                          -> ::std::os::raw::c_int;
    pub fn rdline_get_buffer(rdl: *mut Struct_rdline) -> *const ::std::os::raw::c_char;
    ...
    pub fn cfsetospeed(__termios_p: *mut Struct_termios,
                       __speed: speed_t)
                       -> ::std::os::raw::c_int;
    pub fn cfsetispeed(__termios_p: *mut Struct_termios,
                       __speed: speed_t)
                       -> ::std::os::raw::c_int;
    pub fn cfsetspeed(__termios_p: *mut Struct_termios, __speed: speed_t) -> ::std::os::raw::c_int;
    ...
    pub fn cmdline_new(ctx: *mut cmdline_parse_ctx_t,
                       ...
                       -> *mut Struct_cmdline;
    pub fn cmdline_set_prompt(cl: *mut Struct_cmdline, prompt: *const ::std::os::raw::c_char);
    pub fn cmdline_free(cl: *mut Struct_cmdline);
    pub fn cmdline_printf(cl: *const Struct_cmdline, fmt: *const ::std::os::raw::c_char, ...);
