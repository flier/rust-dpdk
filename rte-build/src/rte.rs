...
lazy_static! {
    pub static ref RTE_SDK: PathBuf = env::var("RTE_SDK")
        ...
        .into();
    pub static ref RTE_ARCH: String = env::var("RTE_ARCH").unwrap_or(ARCH.to_owned());
    pub static ref RTE_MACHINE: String = env::var("RTE_MACHINE").unwrap_or(MACHINE.to_owned());
    pub static ref RTE_OS: String = env::var("RTE_OS").unwrap_or(OS.to_owned());
    pub static ref RTE_TOOLCHAIN: String =
        env::var("RTE_TOOLCHAIN").unwrap_or(TOOLCHAIN.to_owned());
    pub static ref RTE_TARGET: String = env::var("RTE_TARGET").unwrap_or(format!(
        "{}-{}-{}app-{}",
